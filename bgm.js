...
function label(){const b=document.querySelector('#bgm-choice');if(b){b.textContent=choice==='original'?'BGM：元の曲':'BGM：新しい曲';b.title=failed?'曲を読み込めませんでした。元のBGMで再生しています。':'タップして新しい曲／元の曲を切り替え';b.setAttribute('aria-label',b.textContent+'。タップで切り替え')}}
